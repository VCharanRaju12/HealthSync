...
class PatientComp extends Component {
  ...
  handleValidateAll = () => {
    if (this.state.patAadhar.length > 12) {
      this.setState({
        validateText: "Aadhar no. should be less than 12 digits",
      });
    } else if (this.state.patAadhar.length < 12) {
      this.setState({
        validateText: "Aadhar no. should be more than 12 digits",
      });
    ...
    <div className="pat">
      ...
      <div className="container">
        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormGroup row>
            <Col md={{ size: 10, offset: 1, left:3 }}>
              <br /><br />
